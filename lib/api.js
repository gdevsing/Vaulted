...
export async function fetchOwners() {
  ...
  return [
    { key: "H", label: settings.owner_H_label || "Husband", active: settings.owner_H_active !== "0" },
    { key: "W", label: settings.owner_W_label || "Wife",    active: settings.owner_W_active !== "0" },
    { key: "J", label: settings.owner_J_label || "Joint",   active: settings.owner_J_active !== "0" },
  ].filter(o => o.active);
}
