...
export const ACCOUNTS = [
  { id: 1,  name: "Up Bank",       institution: "Up",        owner: "H", asset: "cash",   currency: "AUD", balance: 8200,  nativeBalance: null,  updated: "2026-05-18", group: null,    overdue: false, frequency: "weekly"      },
  { id: 2,  name: "NAB Everyday",  institution: "NAB",       owner: "H", asset: "cash",   currency: "AUD", balance: 6400,  nativeBalance: null,  updated: "2026-05-18", group: null,    overdue: false, frequency: "weekly"      },
  { id: 3,  name: "ANZ Savings",   institution: "ANZ",       owner: "H", asset: "cash",   currency: "AUD", balance: 7100,  nativeBalance: null,  updated: "2026-05-18", group: null,    overdue: false, frequency: "weekly"      },
  { id: 4,  name: "ING Orange",    institution: "ING",       owner: "H", asset: "cash",   currency: "AUD", balance: 6500,  nativeBalance: null,  updated: "2026-05-15", group: null,    overdue: false, frequency: "weekly"      },
  { id: 5,  name: "Stake ASX",     institution: "Stake",     owner: "H", asset: "shares", currency: "AUD", balance: 9800,  nativeBalance: null,  updated: "2026-05-18", group: "Stake", overdue: false, frequency: "fortnightly" },
  { id: 6,  name: "Stake Wall St", institution: "Stake",     owner: "H", asset: "shares", currency: "USD", balance: 13220, nativeBalance: 8530,  updated: "2026-05-18", group: "Stake", overdue: false, frequency: "fortnightly" },
  { id: 7,  name: "Spaceship",     institution: "Spaceship", owner: "H", asset: "shares", currency: "AUD", balance: 9080,  nativeBalance: null,  updated: "2026-05-04", group: null,    overdue: true,  frequency: "monthly"     },
  { id: 8,  name: "Swyftx",        institution: "Swyftx",    owner: "H", asset: "crypto", currency: "AUD", balance: 8950,  nativeBalance: null,  updated: "2026-05-18", group: null,    overdue: false, frequency: "weekly"      },
  { id: 9,  name: "Husband Super", institution: "AustralianSuper", owner: "H", asset: "super", currency: "AUD", balance: 5100, nativeBalance: null, updated: "2026-04-18", group: null, overdue: false, frequency: "monthly"  },
  { id: 10, name: "Wife Super",    institution: "Hostplus",  owner: "W", asset: "super",  currency: "AUD", balance: 4100,  nativeBalance: null,  updated: "2026-04-18", group: null,    overdue: false, frequency: "monthly"     },
];
